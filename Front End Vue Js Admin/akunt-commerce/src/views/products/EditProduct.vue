    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
     ...
     <div class="container my-5">
        <div class="row justify-content-center">
            <div class="col-8">
                <router-link :to="{ name: 'product.index'}" class="btn btn-primary btn-sm rounded shadow mb-3">Back</router-link>
    ...
    setup() {
        ...
        onMounted(()=>{
            ...
            .then((result)=>{
                ...
                transaction.short_description = result.data.data.short_description
                transaction.description = result.data.data.description
                transaction.regular_price = result.data.data.regular_price
                transaction.sale_price = result.data.data.sale_price
                transaction.SKU = result.data.data.SKU
                transaction.stock_status = result.data.data.stock_status
                transaction.featured = result.data.data.featured
                transaction.quantity = result.data.data.quantity
                transaction.image = result.data.data.image
                transaction.category_id = result.data.data.category_id
